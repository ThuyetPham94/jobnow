...
@section('extra-lib')
	<script type="text/javascript">
		function detroy(id)  {
			...
			if (r) {
				$.ajax({
					url: '{!! route('admin.companysize.postDelete') !!}',
					type: 'POST',
...
@section('content')
	<div style="margin-bottom: 15px;">
		{!! HTML::link(route('admin.companysize.getCreate'), 'Thêm mới', ['class'=> 'btn btn-success pull-right']) !!}
	...
	<table class="table table-hover table-bordered">
		...
		<tbody>
			{!! Form::open(['url' => route('admin.companysize.getIndex'), 'method' => 'GET']) !!}
				<tr >
					<td></td>
			...
			<tr id="tr_{!! $item->id !!}">
				...
				<td>
					{!! HTML::decode(HTML::link(route('admin.companysize.getUpdate', ['id' => $item->id]), 'Cập nhật', ['class' => 'btn btn-xs btn-success'])) !!}
